...
| `src/client/java/fun/nursultan/client/mixin/` | Blink, NoServerRotation, NoEntityTrace, NoInteract, LockSlots, NoDelay, Fog, Removals overlays, AspectRatio, FreeLook, NoSlow, NoPush |
