...
Полноценный Android-клиент Telegram на официальном исходнике [DrKLO/Telegram](https://github.com/DrKLO/Telegram) (версия **12.10.3**) с локальными плюшками ExtraGram-стиля.

Это **неофициальный** клиент. Он не связан с Telegram FZ-LLC.

Плюшки (Настройки → Плюшки или пункт в боковом меню):

- приватность: не отправлять «печатает» и прочтение, биометрия на папки и секретные чаты
- чат: свайп (ответ / удаление / закреп), скрытие клавиатуры при скролле, автоплей голосовых, меню сообщения (фото, оригинал, упоминание, ID/JSON)
- долгий тап по аватарке чата открывает медиапрофиль
- Gemini 3.5 Flash-Lite: перевод, саммари, формальный стиль, пунктуация/заглавные, поиск ошибок
- Material You как на Pixel (Android 12+)

Premium Telegram не ломается, чужие удалённые сообщения не восстанавливаются, онлайн не подменяется.
