...
public final class FreeCamera extends Module {
    ...
    public void onHud(net.minecraft.client.gui.GuiGraphics g, int width, int height) {
        ...
        g.drawString(mc.font, String.format("x: %s y: %s z: %s",
                format(mc.player.getX()), format(mc.player.getY()), format(mc.player.getZ())),
                8, height - 20, fun.nursultan.client.ClientSettings.accent, false);
    }
