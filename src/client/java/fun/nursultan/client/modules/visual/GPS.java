...
public final class GPS extends Module {
    ...
    public void onHud(GuiGraphics g, int width, int height) {
        ...
        g.drawString(mc.font, String.format("gps %.0f", dist), width / 2 - 20, 18, fun.nursultan.client.ClientSettings.accent, false);
        ...
        g.fill(x - 2, y - 2, x + 2, y + 2, fun.nursultan.client.ClientSettings.accent);
    }
}
