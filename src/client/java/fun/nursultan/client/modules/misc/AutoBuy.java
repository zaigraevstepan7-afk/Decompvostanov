...
public final class AutoBuy extends Module {
    ...
    private static boolean inCatalog(String id, String name) {
        ...
        return name.contains("тотем") || name.contains("тотем бессмертия")
                ...
                || name.contains("яйцо призыва ифрита")
                || name.contains("Яйцо призыва всполоха".toLowerCase())
                || name.contains("Яйцо призыва пиглина".toLowerCase())
                || name.contains("яйцо призыва гаста")
